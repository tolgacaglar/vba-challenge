...
Sub writeSummaryStatisticsMultiYear()
    ...
    Dim unique_ticker_counter As Long   'Counting the number of unique tickers
    
    Dim last_row As Long    'last row of the current worksheet
    'Run through each worksheet
    For Each ws In Worksheets       'Each worksheet is specific to a year
    ''' DATA COLLECTION
        'row of the first day of the year of the first ticker in the worksheet
        unique_ticker_counter = 0   'The first ticker of the worksheet
        ...
        'Use the same worksheet to put in the analysis
        Dim ws_analysis As Worksheet: Set ws_analysis = ws 'declare worksheet for analysis
        ...
        For ticker_idx = 0 To unique_ticker_counter - 1
            ...
            If yearly_change = 0 Then
                percent_change = 0
            ElseIf first_day_price_array(ticker_idx) = 0 Then
                percent_change = Nan
            Else
        ...
        ws_analysis.Range("Q2:Q3").NumberFormat = "0.00%"
    Next
End Sub
